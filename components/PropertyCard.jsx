      ...
      <div className='p-4'>
        ...
        <div className='flex justify-center gap-4 text-gray-500 mb-4'>
          <p>
            ...
            <span className='md:hidden lg:inline'> Hab</span>
          </p>
          <p>
        ...
        <div className='flex justify-center gap-4 text-green-900 text-sm mb-4'>
          {property.rates?.nightly != null && (
            <p>
              <FaMoneyBill className='md:hidden lg:inline mr-2' /> Noche
            </p>
          )}
          {property.rates?.weekly != null && (
            <p>
              <FaMoneyBill className='md:hidden lg:inline mr-2' /> Semana
            </p>
          )}
          {property.rates?.monthly != null && (
            <p>
              <FaMoneyBill className='md:hidden lg:inline mr-2' /> Mes
            </p>
          )}
        </div>
