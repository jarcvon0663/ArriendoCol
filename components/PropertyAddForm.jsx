    ...
    <form action={addProperty}>
      ...
      <div className='mb-4'>
        ...
        >
          ...
          <option value='CabinOrCottage'>Cabaña</option>
          <option value='Room'>Habitación</option>
          <option value='Studio'>ApartaStudio</option>
      ...
      <div className='mb-4'>
        ...
        <input
          ...
          placeholder='Ej: Hermoso apartamento en Bogotá'
          required
        />
      </div>
      <div className='mb-4'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 gap-2'>
          ...
          <div>
            <input
              ...
              className='mr-2'
            />
            <label htmlFor='amenity_kitchen'>Cocina integral</label>
          </div>
          <div>
            <input
              type='checkbox'
          ...
          <div>
            <input
              ...
              className='mr-2'
            />
            <label htmlFor='amenity_free_parking'>Parqueadero</label>
          </div>
          <div>
            <input
              type='checkbox'
          ...
          <div>
            <input
              ...
              className='mr-2'
            />
            <label htmlFor='amenity_elevator_access'>Ascensor</label>
          </div>
          <div>
            <input
              type='checkbox'
              ...
              className='mr-2'
            />
            <label htmlFor='amenity_dishwasher'>Lavaplatos</label>
          </div>
          <div>
            <input
              type='checkbox'
      ...
      <div className='mb-4 bg-blue-50 p-4'>
        <label className='block text-gray-700 font-bold mb-2'>
          Precios (Deja en blanco si no aplica)
        </label>
      ...
      <div className='mb-4'>
        <label htmlFor='images' className='block text-gray-700 font-bold mb-2'>
          Fotos (Seleccione hasta 4 fotos)
        </label>
        <input
          type='file'
          id='images'
